...
import 'package:flutter_node_auth/features/news/screens/article_view.dart';
...
class _NewsSectionState extends State<NewsSection> {
 ...
 bool _loading = true;
  ...
  Get.snackbar( margin: EdgeInsets.all(10),'Updated', 'The news are up to date!');         
   return getNews();
  }
      ...
      MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
             ...
             // Body Part
              body:_loading ? NewsShimmer(): RefreshIndicator(
                onRefresh: onRefresh,
                  ...
                  child: Container(
                    ...
                    child:  Column(
                      children:<Widget> [
                        ...
                        // Container(
                        //   child: Text(newsProvider.articleModel.title),
                        // )
                      ],
                    ),
                  ),
